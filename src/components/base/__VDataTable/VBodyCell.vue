<template>
    ...
    <td v-else :style="containerStyle" :class="containerClass" @click="onClick" @keydown="onKeyDown" role="cell">
        ...
        <component
            ...
            :index="rowIndex"
            :frozenRow="frozenRow"
            v-else-if="column.children && column.children.body && !column.children.editor && d_editing"
        />
        ...
        <template v-else-if="columnProp('expander')">
            <button class="p-row-toggler p-link" @click="toggleRow" type="button">
...
import RowRadioButton from './VRowRadioButton'
import RowCheckbox from './VRowCheckbox'
