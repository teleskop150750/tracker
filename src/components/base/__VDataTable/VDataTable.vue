...
import Paginator from '../VPaginator/VPaginator'
import VirtualScroller from '../VirtualScroller/VirtualScroller'
import TableHeader from './VTableHeader.vue'
import TableBody from './VTableBody.vue'
import TableFooter from './VTableFooter.vue'
        ...
        filter(data) {
            ...
            if (this.filters['global']) {
                globalFilterFieldsArray =
                    this.globalFilterFields || this.columns.map((col) => this.columnProp(col, 'filterField') || this.columnProp(col, 'field'))
            }
            ...
            for (let i = 0; i < data.length; i++) {
                ...
                if (this.filters['global'] && !globalMatch && globalFilterFieldsArray) {
                    for (let j = 0; j < globalFilterFieldsArray.length; j++) {
                        ...
                        globalMatch = FilterService.filters[this.filters['global'].matchMode || FilterMatchMode.CONTAINS](
...
.p-datatable .p-sortable-column:focus {
    ...
    box-shadow: inset 0 0 0 0.15rem rgb(38 143 255 / 50%);
}
...
.p-datatable .p-datatable-tbody > tr:focus {
    outline: 0.15rem solid rgb(38 143 255 / 50%);
...
.p-datatable .p-datatable-tbody > tr.p-datatable-dragpoint-top > td {
    box-shadow: inset 0 2px 0 0 hsl(211deg 100% 50%);
}
