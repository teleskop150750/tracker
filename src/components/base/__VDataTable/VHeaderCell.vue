...
import HeaderCheckbox from './VHeaderCheckbox.vue'
import ColumnFilter from './VColumnFilter.vue'
    ...
    methods: {
        ...
        isColumnSorted() {
            return this.sortMode === 'single'
                ? this.sortField && (this.sortField === this.columnProp('field') || this.sortField === this.columnProp('sortField'))
                : this.isMultiSorted()
        },
