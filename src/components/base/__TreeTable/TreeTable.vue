...
<script>
import { ObjectUtils, DomHandler } from '../../utils'
import { FilterService } from '../../api/Api'
import TreeTableRow from './TreeTableRow.vue'
import HeaderCell from './HeaderCell.vue'
import FooterCell from './FooterCell.vue'
import Paginator from '../VPaginator/VPaginator.vue'
            ...
            for (let node of value) {
                ...
                for (let j = 0; j < this.columns.length; j++) {
                    ...
                    if (this.hasGlobalFilter() && !globalMatch) {
                        ...
                        if (
                            (strict &&
                                (this.findFilteredNodes(copyNodeForGlobal, globalFilterParamsWithoutNode) ||
                                    this.isFilterMatched(copyNodeForGlobal, globalFilterParamsWithoutNode))) ||
                            (!strict &&
                                (this.isFilterMatched(copyNodeForGlobal, globalFilterParamsWithoutNode) ||
                                    this.findFilteredNodes(copyNodeForGlobal, globalFilterParamsWithoutNode)))
                        ) {
