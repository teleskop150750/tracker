...
export default {
        ...
        getAriaPosInset(index) {
            return (
                (this.optionGroupLabel
                    ? index - this.visibleOptions.slice(0, index).filter((option) => this.isOptionGroup(option)).length
                    : index) + 1
            )
        },
        show(isFocus) {
        ...
        findNextOptionIndex(index) {
            const matchedOptionIndex =
                index < this.visibleOptions.length - 1
                    ? this.visibleOptions.slice(index + 1).findIndex((option) => this.isValidOption(option))
                    : -1
            return matchedOptionIndex > -1 ? matchedOptionIndex + index + 1 : index
        },
        findPrevOptionIndex(index) {
            const matchedOptionIndex =
                index > 0 ? this.visibleOptions.slice(0, index).findLastIndex((option) => this.isValidOption(option)) : -1
    ...
    computed: {
            ...
            return [
                ...
                this.inputClass,
                {
                    ...
                    'p-dropdown-label-empty':
                        !this.editable && !this.$slots['value'] && (this.label === 'p-emptylabel' || this.label.length === 0),
                },
            ]
        },
        panelStyleClass() {
        ...
        filterMessageText() {
            return this.filterMessage || 'searchMessage'
        },
        ...
        selectionMessageText() {
            return this.selectionMessage || 'selectionMessage'
        },
        emptySelectionMessageText() {
            return this.emptySelectionMessage || 'emptySelectionMessage'
        },
        selectedMessageText() {
